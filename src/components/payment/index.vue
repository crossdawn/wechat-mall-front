<template>
  <div class="payment">
    <div class="user-info">
      ...
      <div class="item"><label>是否需要发票</label><input placeholder="" v-model="address" type="checkbox">
      </div>
      <div class="item"><label>发票抬头</label><input placeholder="发票抬头" v-model="address" type="text"></div>
